    ...
    setInterval(function() {
        ...
        if (requireShielding === true) {
            ...
            switch (intervalState) {
                case 1:
                    listUnspent(poolOptions.address, null, 10, false, sendTToZ);
                    break;
                default:
                    listUnspentZ(poolOptions.zAddress, 10, false, sendZToT);
                    intervalState = 0;
                    break;
            }
        }
                ...
                daemon.batchCmd(batchRPCcommand2, function(error, blockDetails){
                    ...
                    redisClient.multi(confirmsUpdate).exec(function(error, updated){
                        ...
                        daemon.batchCmd(batchRPCcommand, function(error, txDetails){
                            ...
                            listUnspent(null, notAddr, 10, false, function (error, tBalance){
                                if (error) {
